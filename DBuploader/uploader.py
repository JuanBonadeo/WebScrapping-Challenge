...
def prices(brand_name: str, date: str = ''):
    try:
        conn = psycopg2.connect(
            dbname="postgres",
            user="postgres",
        ...
        file_path = f'./data/{brand_name}_item_prices{date}.csv'
...
prices(brand_name='sedanos', date='_14_05')
prices(brand_name='sedanos', date='_15_05')
prices(brand_name='sedanos', date='_16_05')
prices(brand_name='sedanos', date='_17_05')

prices(brand_name='cotsco', date='_14_05')
prices(brand_name='cotsco', date='_15_05')   
prices(brand_name='cotsco', date='_16_05')
prices(brand_name='cotsco', date='_17_05')